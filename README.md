...
[![Build Status](https://travis-ci.org/kidibox/kidibox-ui.svg?branch=master)](https://travis-ci.org/kidibox/kidibox-ui?branch=master)
[![dependencies](https://david-dm.org/kidibox/kidibox-ui.svg)](https://david-dm.org/kidibox/kidibox-ui)
[![devDependency Status](https://david-dm.org/kidibox/kidibox-ui/dev-status.svg)](https://david-dm.org/kidibox/kidibox-ui#info=devDependencies)
